...
<template>
    <main>
        ...
        <div class="content-nav">
            <ul class="wrap-card">
                <div class="container">
                    <li class="card" v-for="(icon, index) in merch" :key="index">
                        <img :src="getImageUrl(`../assets/img/${icon.img}`)" :alt="icon.href">
                        <a :href="icon.href"> {{ icon.name }}</a>
